print("Unit Converter - by Hafsa Noorain")
print("===============")
...
if change == 1:
    ...
    length_dict = \
        {
            ...
            7: "Centimeter to FEET",
            8: "FEET to Centimeter",
            9: "Kilometre to Mile",
    ...
    if length_convert == 1:
        ...
        print("{} sqfeet is equal to {} sqmeters".format(length_value, length_value * 0.09290304))
    elif length_convert == 13:
        print("{} sqfeet is equal to {} hectares".format(length_value, length_value * 0.000009290303997))
    elif length_convert == 14:
        print("{} sqfeet is equal to {} Acres".format(length_value, length_value / 43560))
    else:
...
print("hafsanoorain242@gmail.com")